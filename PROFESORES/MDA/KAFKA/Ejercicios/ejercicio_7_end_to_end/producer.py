...
# Tus datos (pueden venir de un archivo)
transferencias = [
...
for t in transferencias:
    # Enviamos cada una como JSON
    producer.produce(topic, value=json.dumps(t).encode('utf-8'))
    print(f"Enviada transferencia: {t['id_transferencia']}")
